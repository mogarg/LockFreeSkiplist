...
public class ConcurrentSkipListNoRangeHighContentionBenchmark {

    private ConcurrentSkipListSet<Integer> list;

    public ConcurrentSkipListNoRangeHighContentionBenchmark() {
    ...
    public static class OperationState {
        ...
        public OperationState() {
            this.opGen = new OperationGenerator(0.33, 0.33, 0.34, 100);
        }
    }
